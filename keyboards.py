...
inlinekeyboard.add(InlineKeyboardButton("⏭️Быстрый поиск", switch_inline_query_current_chat=''),)
...
InlineKeyboardButton(text="🆔Поиск по ID", callback_data='id'))
...
contacts.add(InlineKeyboardButton(text="✈️ Наш канал", url="https://t.me/FilmPrimiere"),
InlineKeyboardButton(text="📝 Наш чат", url="https://t.me/FilmPrimiere"))
